...
module.exports = {
    ...
    async execute(interaction, client) {
        ...
        await TargetUser.send({ 
            content: `You have been muted in **${guild.name}** for the reason: ${MuteReason}\Duration: ${MuteDuration} If you wish to appeal follow this link: <https://dyno.gg/form/b72ba489>`
        }).catch(console.error);
