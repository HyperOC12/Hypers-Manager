...
module.exports = {
    ...
    async execute(interaction, client) {
        ...
        .setFields(
            ...
            {
                name: '• Moderation',
                value: inlineCode('ban, purge, kick, lock, unlock, mod, mute, nick, slowmode, unban, warn, rmpunish')
            },
            {
                name: '• Misc',
                value: inlineCode('avatar, diner, freeban, poll, say')
            },
            {
                name: '• Games',
            ...
            {
                name: '• Util',
                value: inlineCode('automod, customrole, debug, ping')
            }
        )
